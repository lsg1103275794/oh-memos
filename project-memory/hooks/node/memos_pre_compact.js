 ...
 * 2. Tell the model to call memos_context_resume AFTER compaction completes
 *
...
console.error('║    memos_save(content=..., memory_type="PROGRESS",           ║');
console.error('║              project_path="<current working dir>")           ║');
console.error('║                                                              ║');
console.error('║  AFTER compaction — recover context:                         ║');
console.error('║    memos_context_resume(project_path="<current working dir>")║');
console.error('║                                                              ║');
