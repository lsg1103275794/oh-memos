 ...
 * This enables zero-explicit-memos_search context awareness.
 *
...
const MEMOS_API_HOST = 'localhost';
const MEMOS_API_PORT = 18000;
const MEMOS_USER = 'dev_user';
const TOP_K = 3;
...
function extractGlobKeyword(pattern) {
  ...
  // Extract meaningful part: "WebSocket*" -> "WebSocket", "memos_*.js" -> "memos"
