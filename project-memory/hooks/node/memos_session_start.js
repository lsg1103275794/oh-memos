#!/usr/bin/env node
/**
 * MemOS Hook: SessionStart - Output CWD → cube_id mapping
 *
...
console.error(`[MemOS] Project: ${folderName} → cube_id: "${fullCubeId}"`);
console.error(`[MemOS] Use project_path="${cwd}" in memos_save/memos_search for correct cube routing.`);
